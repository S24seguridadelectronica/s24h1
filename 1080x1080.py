...
for archivo in archivos:
    try:
        ...
        imagen_nueva = imagen_original.resize((1080, 1080))
        ...
        print(f"¡Imagen '{archivo}' convertida, redimensionada y guardada con éxito en la carpeta 'datos'!")
...
print("¡Nombres de archivos guardados en 'nombres_archivos.txt' en la carpeta 'datos'!")
