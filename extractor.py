...
body {
    ...
    color: white; /* Color del texto blanco para que sea legible en el fondo negro */
}
...
.btn-custom {
    ...
    padding: 5vw 10vw; /* Espaciado interno */
    font-size: 10vw; /* Tamaño del texto */
    cursor: pointer; /* Cursor al pasar */
    transition: background-color 0.3s ease; /* Transición suave */
    margin: 10vh auto; /* Margen automático izquierdo y derecho, y 10px arriba y abajo */
    display: inline-block; /* Permite que el botón respete el margen automático */
    height: 10vh; /* Altura del botón */
    width: 75vw; /* Anchura del botón */
    line-height: 10px; /* Alinea verticalmente el texto */

}

.btn-custom:hover {
    background-color: darkorange; /* Cambio de color al pasar el cursor */
}
...
.modal-header {
    ...
    border-top-left-radius: 15px; /* Bordes redondeados arriba */
    border-top-right-radius: 15px;
}

.modal-body {
    padding: 30px; /* Mayor espacio entre el contenido y los bordes */
    font-family: 'Arial', sans-serif; /* Fuente legible */
}

.modal-footer {
    border-bottom-left-radius: 15px; /* Bordes redondeados abajo */
    border-bottom-right-radius: 15px;
}

.modal-footer .btn-secondary {
    background-color: #6c757d; /* Botón secundario de color gris */
    border-color: #6c757d;
}

.modal-footer .btn-primary {
    background-color: #28a745; /* Botón primario de color verde */
    border-color: #28a745;
}
...
"""
            ...
            <div class="col-lg-12 col-md-6">
                <div class="content">
                    ...
                    <div class="btn-container">
                     <button class="btn btn-custom btn-block" onclick="redirectToForm()">Contactar</button>
                    </div>
                </div>
            </div>
            """
    ...
    <div class="col-lg-10 col-md-6">
        <div class="content">
            ...
            <div class="btn-container">
             <button class="btn btn-success btn-block" onclick="redirectToForm()">Contactar</button>
            </div>
        </div>
    </div>
    """
    ...
    <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2 mb-4">
        <div class="form-container">
            ...
            <form id="myForm">
                ...
                <button type="button" class="btn btn-primary btn-block custom-btn" data-toggle="modal" data-target="#myModal">
                    Enviar
                </button>
            </form>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h4 class="modal-title">¡Gracias por tu compra!</h4>
